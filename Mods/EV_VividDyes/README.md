...
1. Copy the `EV_VividDyes` folder into your game's `Mods/` directory
...
Based on the original [7 Days to Dye](https://www.nexusmods.com/7daystodie/mods/526) mod by **TheOptimalNoob**. The original mod was created for Alpha 18 and has been fully rewritten and adapted for the current version of 7 Days to Die with updated item modifier structure, loot integration, and localization.
