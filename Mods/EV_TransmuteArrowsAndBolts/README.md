...
1. Copy the `EV_TransmuteArrowsAndBolts` folder into your game's `Mods/` directory
...
- Adds new recipes only — no vanilla recipe modifications, so conflicts are unlikely
